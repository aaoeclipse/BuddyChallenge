    ...
    <div class="min-h-full">
        ...
        <main>
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <!-- GRID -->
                <div class="grid md:grid-cols-3 grid-cols-1 px-4 w-full gap-4 pb-4">
                    <!-- CURRENT -->
                    <div
                        class="md:col-span-2 min-h-[10rem] p-4 gap-3 flex flex-col items-center bg-slate-100 rounded shadow-md">
                        <h2 class=" text-2xl pb-2">Current</h2>
                        <CardChallenge />
                        <CardChallenge />
                        <CardChallenge />
                        <CardChallenge />
                     ...
                     border-transparent bg-indigo-600 px-3 py-2 
                    ...
                    <!-- PENDING -->
                    <div class="col-span-1 min-h-[10rem] p-4 flex flex-col items-center bg-slate-100 rounded shadow-md">
                        <h2 class=" text-2xl">Pending</h2>
                        <PendingCardChallengeVue />
                    </div>
...
import { Bars3Icon, BellIcon, EnvelopeIcon, PlusIcon, XMarkIcon } from '@heroicons/vue/24/outline'
import CardChallenge from "./CardChallenge.vue"
import PendingCardChallengeVue from './PendingCardChallenge.vue';
