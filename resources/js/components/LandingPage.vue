                    ...
                    <nav class="relative mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6"
                        ...
                        <div class="flex flex-1 items-center">
                            <div class="flex w-full items-center justify-between md:w-auto">
                                <a href="#">
                                    <span class="sr-only">Buddy Challenge</span>
                        ...
                        <div class="hidden md:flex md:items-center md:space-x-6">
                            ...
                            <a href="/register"
                                class="inline-flex items-center rounded-md border border-transparent bg-gray-600 px-4 py-2 text-base font-medium text-white hover:bg-gray-700">Register</a>
                        </div>
                    </nav>
                </div>
        ...
        item.name
                                ...
                                <div class="mt-6 px-5">
                                    <p class="text-center text-base font-medium text-gray-500">Existing customer? <a
                                            href="/login" class="text-gray-900 hover:underline">Login</a></p>
                                </div>
                            </div>
                        </div>
                    </PopoverPanel>
            ...
            <main>
                            ...
                            <div
                                ...
                                <div class="lg:py-24">
                                    <a href="#"
                                        ...
                                        <span
                                            class="rounded-full bg-gradient-to-r from-teal-500 to-cyan-600 px-3 py-0.5 text-sm font-semibold leading-5 text-white">Get
                                            exited</span>
                                        <span class="ml-4 text-sm">View our clients results</span>
                                    ...
                                    <h1
                                        ...
                                        <span class="block">Buddy Challenge</span>
                                        <span
                                            class="block bg-gradient-to-r from-teal-200 to-cyan-400 bg-clip-text pb-3 text-transparent sm:pb-5">challenge
                                            everybody</span>
                                    </h1>
                                    <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">BuddyChallenge
                                        is a
                                        social fitness platform that allows users to challenge their friends to go to
                                        the gym and get fit together. With GymBuddy, users can create and join fitness
                                        challenges, track their workouts, and share their progress with their friends.
                                        Join GymBuddy today and start reaching your fitness goals with the support of
                                        your friends!
                                    </p>
                                </div>
                            </div>
                ...
                <div class="relative bg-gray-50 pt-16 sm:pt-24 lg:pt-32">
                    <div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                        <div>
                            <h2 class="text-lg font-semibold text-cyan-600">Challenges</h2>
                            <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Challenge your
                                friends and family</p>
                            <p class="mx-auto mt-5 max-w-prose text-xl text-gray-500">Motivate each other with your
                                workouts and challenges, help each other in the clash for points in order to be number
                                1.</p>
                        </div>
                            ...
                            <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
                                <blockquote>
                                    <div>
                                        ...
                                        <p class="mt-6 text-2xl font-medium text-white">Lorem ipsum dolor sit amet,
                                            consectetur adipiscing elit. Sed urna nulla vitae laoreet augue. Amet
                                            feugiat est integer dolor auctor adipiscing nunc urna, sit.</p>
                                    </div>
                                    <footer class="mt-6">
