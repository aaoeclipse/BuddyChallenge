                    ...
                    <nav class="relative mx-auto flex max-w-7xl items-center justify-between px-6" aria-label="Global">
                        <div class="flex flex-1 items-center">
                            <div class="flex w-full items-center justify-between md:w-auto">
                                <a href="#">
                                    <span class="sr-only">BuddyChallenge</span>
                                    <img class="h-10 w-[6rem] sm:h-[6rem] filter bg-blue-200 justify-center rounded-full"
                                        src="/img/logo_svg.svg" alt="" />
                                </a>
                            </div>
                        ...
                        <div class="lg:grid lg:grid-cols-2 lg:gap-8">
                            <div
                                ...
                                <div class="lg:py-24">
                                    ...
                                    <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">BuddyChallenge
                                        is a web app that lets you challenge a friend to an exciting workout routine.
                                        Track your progress, view your stats, and compete with friends. Create your own
                                        personalized workouts, set goals, and track your progress. With BuddyChallenge,
                                        you can challenge yourself and your friends to stay motivated and reach your
                                        fitness goals. Take control of your fitness journey and have fun as you reach
                                        your goals.</p>
                            ...
                            <div class="mt-12 -mb-16 sm:-mb-48 lg:relative lg:m-0">
                                <div class="mx-auto max-w-md px-6 sm:max-w-2xl lg:max-w-none lg:px-0">
                                    ...
                                    <img class="w-full rounded lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-auto lg:max-w-none"
                                        src="/img/landing/landing.jpeg" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
